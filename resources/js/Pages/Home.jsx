          ...
          <div className="mt-6 flex flex-col items-center">
            ...
            <div className="w-full flex-1 mt-4 md:mt-8">
              <div className="flex flex-col items-center">
                ...
                <button
                  className="w-full max-w-xs font-bold shadow-sm rounded-lg py-1 lg:py-3 bg-indigo-100 text-gray-800 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline mt-5"
                >
                  <div className="bg-white p-0 md:p-1 rounded-full">
              ...
              <div className="mx-auto max-w-xs">
                <input
                  className="w-full px-8 py-1 md:py4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white"
                  type="email"
                  placeholder="Email"
                />
                <input
                  className="w-full px-8 py-1 md:py4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white mt-5"
                  type="password"
